...
struct EvaluateView: View {
    ...
    let questions: [Question] = [
        ...
        Question(id: 9, text: "คุณสังเกตเห็นว่าส้นเท้าหรือฝ่าเท้าของคุณมีอาการบวมหรือแดงเล็กน้อยใช่หรือไม่?", score: 3),
        Question(id: 10, text: "อาการเจ็บของคุณดีขึ้นเพียงชั่วคราวหลังจากนวดหรือพักเท้า แล้วกลับมาปวดอีกครั้งใช่หรือไม่?", score: 3)
    ]
