            ...
            VStack(spacing: 0) {
                ...
                ScrollView(showsIndicators: false) {
                    VStack(alignment: .leading, spacing: 20) {
                        ...
                        การเปิดเผย: ไม่เปิดเผยแก่บุคคลภายนอก
                        """, icon: "list.bullet.clipboard", color: primaryColor)
                        
                        TermCard(title: "ข้อสงวนสิทธิ์ทางการแพทย์ (Medical Disclaimer)", content: """
                        เนื้อหา ฟังก์ชันการวิเคราะห์รูปเท้า AI และคำแนะนำท่าออกกำลังกายภายในแอปพลิเคชัน Plantar มีวัตถุประสงค์เพื่อให้ข้อมูลทั่วไปและประเมินความเสี่ยงเบื้องต้นเท่านั้น แอปพลิเคชันนี้ 'ไม่ใช่' อุปกรณ์ทางการแพทย์ และไม่สามารถใช้ทดแทนการวินิจฉัย การรักษา หรือคำแนะนำทางการแพทย์จากผู้เชี่ยวชาญได้ ผู้พัฒนาแอปพลิเคชันจะไม่รับผิดชอบต่อการบาดเจ็บหรือผลกระทบใดๆ ที่เกิดจากการนำข้อมูลในแอปพลิเคชันไปใช้โดยไม่ปรึกษาแพทย์
                        """, icon: "list.bullet.clipboard", color: primaryColor)
